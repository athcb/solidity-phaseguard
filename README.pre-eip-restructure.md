...
[`IPhaseGuard`](src/IPhaseGuard.sol) defines the minimal standard interface. [`PhaseGuard`](src/PhaseGuard.sol) is the reference implementation.
...
The policy bitmask currently uses three flags: `ALLOW_USER`, `ALLOW_ADMIN`, and `ALLOW_VIEWS`. Bits 3 through 7 are reserved for future use.

## Reference implementation

- [`src/PhaseGuard.sol`](src/PhaseGuard.sol) — reference implementation of `IPhaseGuard`
- [`src/extensions/PhaseGuardERC4626.sol`](src/extensions/PhaseGuardERC4626.sol) — integration example with an ERC-4626 vault
